...
exports.orderBy = exports.OrderByEnum = exports.FileScalar = exports.Upload = exports.AnyScalar = exports.DateScalar = void 0;
...
exports.FileScalar = (0, nexus_1.scalarType)({
    name: "File",
    asNexusMethod: "file",
});
var OrderByEnum;
...
exports.orderBy = (0, nexus_1.enumType)({
    name: "OrderByEnum",
    members: OrderByEnum,
});
