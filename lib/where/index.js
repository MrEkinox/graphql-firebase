...
exports.WhereCollection = exports.orderByCreatedAt = void 0;
...
const orderByCreatedAt = (edges) => {
    return edges.sort((a, b) => {
        var _a, _b;
        return firestore_1.Timestamp.fromMillis(((_a = a.node.createdAt) === null || _a === void 0 ? void 0 : _a.toMillis()) || 0).toMillis() >
            firestore_1.Timestamp.fromMillis(((_b = b.node.createdAt) === null || _b === void 0 ? void 0 : _b.toMillis()) || 0).toMillis()
            ? -1
            : 1;
    });
};
exports.orderByCreatedAt = orderByCreatedAt;
class WhereCollection {
    constructor(schema, parentsIds) {
    ...
    async chunkQuery(collection, ids) {
        ...
        return allData.reduce((acc, cur) => {
            ...
            const newEdges = (0, exports.orderByCreatedAt)([...cur.edges, ...acc.edges]);
    ...
    async getData(collection) {
        ...
        const edges = (0, exports.orderByCreatedAt)(data.docs.map((doc) => ({
