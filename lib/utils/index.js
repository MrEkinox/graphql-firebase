...
exports.hasEdgeField = exports.hasCountField = exports.isOnlyIdField = exports.getSchemaFields = exports.plural = exports.getParentIdLabel = exports.firstLowercase = exports.capitalize = exports.getDefinitionFields = void 0;
...
const hasCountField = (info) => {
    const fields = (0, graphql_fields_list_1.fieldsList)(info);
    return !!fields.find((field) => field === "count");
};
exports.hasCountField = hasCountField;
const hasEdgeField = (info) => {
    const fields = (0, graphql_fields_list_1.fieldsList)(info);
    return !!fields.find((field) => field === "edges");
};
exports.hasEdgeField = hasEdgeField;
