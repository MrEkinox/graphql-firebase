...
const GraphQLFirebasePlugin = () => {
    ...
    return (0, nexus_1.plugin)({
        ...
        onAfterBuild: () => {
            const endTimeMs = new Date().valueOf();
            console.log(`Generation schema finish in ${endTimeMs - startTimeMs} ms !`);
        },
        onInstall: (builder) => {
            builder.addType((0, nexus_1.dynamicOutputMethod)({
                ...
                factory: (_a) => {
                    ...
                    t.field(fieldName, Object.assign({ resolve: async (src, args, ctx, info) => {
                            return (0, reference_1.referenceResolver)(type, isList, src, info);
                        } }, config.args[1]));
                },
            }));
            builder.addType((0, nexus_1.dynamicOutputMethod)({
            ...
            builder.addType((0, nexus_1.dynamicOutputMethod)({
                ...
                factory: (_a) => {
                    ...
                    t.connectionField(filedName, Object.assign(Object.assign({ getConnectionName: () => `${type}Collection`, resolve: async (src, input, ctx, info) => {
                            return (0, collection_1.collectionResolver)(type, filedName, parents, src, input, info);
                        } }, config.args[1]), { type, additionalArgs: Object.assign(Object.assign({}, config.args[1].additionalArgs), { limit: (0, nexus_1.arg)({ type: "Int", default: 50 }), offset: (0, nexus_1.arg)({ type: "Int", default: 0 }), where: (0, nexus_1.arg)({ type: `${type}WhereInput` }), orderBy: (0, nexus_1.arg)({ type: `${type}OrderByInput` }) }) }));
                },
            }));
        },
    });
