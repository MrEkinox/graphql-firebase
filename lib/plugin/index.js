        ...
        onInstall: (builder) => {
            builder.addType((0, nexus_1.dynamicOutputMethod)({
                ...
                factory: (_a) => {
                    ...
                    t.field(fieldName, Object.assign(Object.assign({}, config.args[1]), { resolve: async (src, args, ctx, info) => {
            ...
            builder.addType((0, nexus_1.dynamicOutputMethod)({
                ...
                factory: (_a) => {
                    ...
                    t.connectionField(filedName, Object.assign(Object.assign({}, config.args[1]), { getConnectionName: () => `${type}Collection`, type, additionalArgs: Object.assign(Object.assign({}, config.args[1].additionalArgs), { limit: (0, nexus_1.arg)({ type: "Int", default: 50 }), offset: (0, nexus_1.arg)({ type: "Int", default: 0 }), where: (0, nexus_1.arg)({ type: `${type}WhereInput` }) }), resolve: async (src, input, ctx, info) => {
